                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="form-group text-left">
                                    ...
                                    <input required autocomplete="off" value="{{ old('title') }}" name="title" type="text"
                                        class="form-control" id="title" placeholder="Judul Video sobat">
                                    @error('title')
                                ...
                                <div class="form-group text-left">
                                    <textarea class="editor" name="description" id="" cols="30"
                                        rows="10">{{ old('description') ?? 'Happy watching :)' }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 ">
                                <div class="form-group my-3">
                                    ...
                                    <input name="code_video" value="{{ old('code_video') }}" autocomplete="off"
                                        placeholder="Z5z1okXtQSA" type="text" class="form-control col-lg-12"
                                        style="width: 100%">
                                ...
                                <div class="form-group my-3">
                                    ...
                                    <input name="tags" type="text" class="form-control col-lg-12" style="width: 100%"
                                        data-role="tagsinput">
                                    <small>Spasi otomatis akan dihilangkan</small>
                                </div>
                                <div class="bg-light preview card p-3 text-center mb-2">
                                    <p>Kita boleh bebas melakukan apapun, tetapi percayalah setiap tindakakan memiliki
                                        ganjaran yang harus kita pertanggung jawabkan</p><br><b>Baik Atau Buruk
                                    </b><br><b>Sekarang Atau Esok</b>
                                    <br>
                                    - Karma ANTEPE -
                                </div>
